...
module mojo_top_0 (
  ...
  always @* begin
    ...
    if (M_pixel_q < 10'h320 && M_line_q < 10'h258) begin
      red = M_bg_r || M_userChar_r || M_enemyChar_r || M_projChar_r;
      green = M_bg_g || M_userChar_g || M_enemyChar_g || M_projChar_g;
      blue = M_bg_b || M_userChar_b || M_enemyChar_b || M_projChar_b;
    end else begin
      red = 1'h0;
      blue = 1'h0;
      green = 1'h0;
